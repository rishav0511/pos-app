...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <fo:page-sequence master-reference="simple" initial-page-number="1">
                <fo:static-content flow-name="xsl-region-before">
                    <fo:block font-size="20.0pt" font-family="serif" padding-after="3.0pt" space-before="5.0pt" text-align="center" border-bottom-style="solid" border-bottom-width="1.0pt">
                        <xsl:text>Increff-POS</xsl:text>
                    </fo:block>
                    <fo:block></fo:block>
                </fo:static-content>
                <fo:static-content flow-name="xsl-region-after">
                    <fo:block font-size="12.0pt" font-family="sans-serif" padding-after="2.0pt" space-before="2.0pt" text-align="center" border-top-style="solid" border-bottom-width="1.0pt">
            ...
            <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                    <fo:table-row>
                        ...
                        <fo:table-cell>
                            <fo:block font-size="12pt" font-family="sans-serif" color="black" text-align="right" padding-top="3pt">
                                Time :
            ...
            <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                    <fo:table-row>
                        ...
                        <fo:table-cell border-style="solid" border-width="1.0pt">
    ...
    <xsl:template match="id">
        <fo:block font-size="12pt" font-family="sans-serif" space-after.optimum="3pt" text-align="center" padding="3pt">
            <xsl:value-of select="." />
        </fo:block>
    </xsl:template>
